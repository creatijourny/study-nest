...
const MyBookingPage = async () => {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6">
            <h2 className="text-2xl font-bold mb-5 mt-7 text-center">My Bookings</h2>

            {myBookings.length === 0 ? (<div className="max-w-7xl mx-auto flex flex-col items-center justify-center py-16 border rounded p-7 space-y-4">
